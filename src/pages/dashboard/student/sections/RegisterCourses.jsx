    ...
    <div>
        <div className="max-w-md">
            <div>
                ...
                <p className="text-xs">Select the academic year, session and your level, then click register courses to proceed with this process</p>
            </div>

            <div  className="mt-14 sm:mt-10">
                <p className="text-xl font-bold pb-2 border-b border-neutral-200">Register Courses</p>
